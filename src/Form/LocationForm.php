...
/**
 * Custom Form to display locations for selected countries .
 */
class LocationForm extends FormBase
{
    ...
    {
        return 'custom_dhl_location_module_form';
    }
    ...
    /**
   *  Validation for city and postal code fields.
   */
    public function validateForm(array &$form, FormStateInterface $form_state)
    {
      // Validate the city field.
        if (empty($form_state->getValue('city'))) {
            $form_state->setErrorByName('city', $this->t('The city field cannot be empty.'));
        }

      // Validate the postal code field.
        if (empty($form_state->getValue('postal_code'))) {
            $form_state->setErrorByName('postal_code', $this->t('The postal code field cannot be empty.'));
        }
    }
